...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-md-offset-3 col-lg-offset-3 col-sm-offset-3">
            ...
            <?php echo form_open('admin/editUnitProcess',array('class'=>"form-horizontal")); ?>
            <input type="hidden" name="id" value="<?php echo $unit->id; ?>">
            <div class="form-group">
                <label for="title" class="col-sm-3 control-label">Unit name</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" value="<?php echo $unit->title; ?>" placeholder="Unit name" name="title">
                </div>
            </div>
            <div class="form-group">
