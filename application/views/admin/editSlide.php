    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-md-offset-3 col-lg-offset-3 col-sm-offset-3">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" id="description" value="<?php echo $slide->content; ?>" placeholder="Description about slide. Leave blank if not applicable." name="description"></textarea>
                </div>
            </div>
            <div class="form-group">
