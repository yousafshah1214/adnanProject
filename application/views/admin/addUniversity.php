...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-md-offset-3 col-lg-offset-3 col-sm-offset-3">
            ...
            <?php echo form_open('admin/addUniversityProcess',array('class'=>"form-horizontal")); ?>
            <div class="form-group">
                <label for="title" class="col-sm-3 control-label">University name</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" placeholder="University name" name="title">
                </div>
            </div>
            <div class="form-group">
                <label for="link" class="col-sm-3 control-label">University Website Link</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="link" placeholder="University Website Link leave blank if not applicable." name="link">
                </div>
            </div>
            <div class="form-group">
